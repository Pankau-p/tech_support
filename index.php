...
<main>
    ...
    <ul>
        ...
        <li><a href="./view/under_construction.php">Display Incidents</a></li>
    </ul>

    <h2>Technicians</h2>    
    <ul>
        <li><a href="./view/under_construction.php">Update Incident</a></li>
    </ul>

    <h2>Customers</h2>
    <ul>
        <li><a href="./view/under_construction.php">Register Product</a></li>
    </ul>
